...
Quite literally any economy building is a good target for slaves if undefended.
You can also use them to dig moat straight from start, as it is technically free.
...
They can run on a ~5 tile patrol, never getting hit by any far away ranged units, but they can keeping shooting back themselves. Use this both offensively and defensively all throughout the game.
...
Assassins, like 1 to 3, depending on how confident your are in your raiding skills. They can break through slingers if rallypointed, or sneak up on more costly ranged units.
...
In case you have gold left over, feel like your defences are already unbreakable and aren't planning on attacking in any way, you can buy wood for more of the same economy you just built.
...
You can keeping selling food for gold, but be careful to not overdo it and lose your popularity.
...
Set up one fletcher, one poleturner and the armory next to your stockpile. If you have the resources for it, you can get up to 5 of each eventually - prioritize doing this.
The weapons can be sold for extra gold as well, but are generally better used for actual army.
If you at any point start overflowing with bows - switch some your fletchers to produce crossbows instead, as those sell for much more than bows.
...
You should also send a few units to cover all entrypoints to your main economy.
If you failed to do so, use your units to hold whatever part of the map is still under your control.

Both european archers and spearmen are cheap and spammable, at this point of the game, you can use combination of them to fight practically anything.
...
If your lord has lost any health or you literally used him to fight off melee units, you can heal him up with an apothecary.
...
Alternatively, you can also use chapels for this, they are cheaper but less reliable.
...
Now, maces can be sold for huge amounts of gold if needed, but you are better off using them for macemen. It is also good to buy leather armor and get macemen before you start producing it.

Macemen counter all melee units up to this point and are far better at tanking arrows and sling shots than spearmen.
Combine the macemen with your spearmen, your army is now much more capable of pushing enemy control points and raiding, make full use of it.
...
- A few blacksmiths producing maces
...
You can also pair them with chapels for even larger popularity boost, although this is unreliable and not very effective if you have most of your population still running outside of your main economy.

The cathedral also allows you recruit monks, which you can mass recruit to give yourself an edge in main army melee fights.
...
When european archers become too spammy or you start facing armored melee units, start switching your fletchers to produce crossbows and start putting out crossbowmen to replace them.
...
Next up you should start switching some of your blacksmiths to produce swords and build armorers to put out european swordsmen.
Swords, and especially metal armor can both be sold for large amount of gold if needed.
...
Negative if you don't have enough army and really need the extra economy power to catch up or outproduce your opponent.
...
You can use their fast movement speed to stack them very quickly, get a few kills and then click them out of combat, repating this to pick off smaller numbers of units at once, disallowing any stacking from happening with enemy units.
...
Combinations of macemen, spearmen and monks can still be effective, but you should primarily focus on swordsmen, pikemen and knights if your economy allows for it.
Your army should then be supported by large amount of crossbowmen with shields, to counter enemy ranged units.
Fireballistas are also very generalist for this.

If you are attacking, build trebuchets and/or catapults, combined with rams to take down any castle defences in your path.
